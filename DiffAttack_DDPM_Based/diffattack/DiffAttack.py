...
class DiffAttack():
    def __init__(self, model, norm='Linf', eps=.3, seed=None, verbose=True,
        ...
        if not self.is_tf_model:
            ...
            self.apgd = APGDDiffAttack(self.model, n_restarts=5, n_iter=100, verbose=True,
                ...
                device=self.device, logger=self.logger, args=self.args)
    ...
    def set_version(self, version='standard'):
        ...
        if version == 'standard':
            ...
            self.apgd.n_iter = 100  # 30 for fast run
