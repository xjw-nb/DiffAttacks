...
def test_bpda_adv(args, model, x_adv, y_val, config):
    ...
    with torch.no_grad():
        ...
        for batch_idx in range(n_batches):
            ...
            end_idx = min((batch_idx + 1) * bs, x_adv.shape[0])
...
def parse_args_and_config():
    ...
    parser.add_argument('--classifier_name', type=str, default='resnet18', help='which classifier to use') #Eyeglasses
